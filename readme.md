...
| 改定日     | 版    | 内容                                                                                             |
| :---:      | :---: | :---:                                                                                            |
| 2019/08/28 | 1     | 新規作成。shellscriptで書いており、[hugo](https://github.com/gohugoio/hugo)を使用していた。      |
| 2019/09/26 | 2     | 画像のbase64エンコード実装。                                                                     |
| 2019/10/01 | 3     | hugoのバイナリを同梱するのをやめた<br>OSに合わせて自動でDLするようにした。                       |
| 2019/10/30 | 4     | shellscriptをやめ全てGolangで書きなおした。<br>これにより全ての使用条件を撤廃、100倍早くなった。 |
| 2019/11/21 | 5     | Hugoの使用を廃止。スライド用html生成を実装。                                                     |
| 2019/11/27 | 5.1   | スライド用htmlの画像サイズのウィンドウサイズによって可変するように変更した。                     |
| 2020/11/30 | 5.2   | ページ数表示に対応                                                                               |
| 2020/12/1  | 5.3   | 埋め込んでいるcssとjavascriptを自前でminifyするようにした                                        |
