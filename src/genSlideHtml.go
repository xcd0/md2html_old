...
func returnCssForSlide(slidePath string) string { // {{{
	...
	if slideCss == "default" {
		slideCss = `
body{font-family:Helvetica,arial,sans-serif;font-size:3.5vmin;padding:0;margin:0;line-height:1.6;background-color:#fff;color:#444;word-wrap:break-word}body>:first-child{margin-top:0!important}body>:last-child{margin-bottom:0!important}a{color:#4183c4;text-decoration:none}a.absent{color:#c00}a.anchor{display:block;padding-left:30px;margin-left:-30px;cursor:pointer;position:absolute;top:0;left:0;bottom:0}h1,h2,h3,h4,h5,h6{margin:20px 0 10px;padding:0;-webkit-font-smoothing:antialiased;cursor:text;position:relative}h1:first-child,h1:first-child+h2,h2:first-child,h3:first-child,h4:first-child,h5:first-child,h6:first-child{margin-top:0;padding-top:0}h1:hover a.anchor,h2:hover a.anchor,h3:hover a.anchor,h4:hover a.anchor,h5:hover a.anchor,h6:hover a.anchor{text-decoration:none}h1 code,h1 tt,h2 code,h2 tt,h3 code,h3 tt,h4 code,h4 tt,h5 code,h5 tt,h6 code,h6 tt{font-size:inherit}h1{font-size:6vh;font-weight:700;margin-bottom:40px;padding-bottom:0}h1,h2{color:#000}h2{font-size:6vh;border-bottom:2px solid #ccc;margin-bottom:3%}h3{font-size:4vh;margin-top:-1.9%;border-bottom:1px solid #ddd;color:#555}h4{font-size:80%}h5{font-size:60%}h6{font-size:40%;color:#777}blockquote,dl,li,ol,p,pre,table{margin:2% 0}code,pre{white-space:pre-wrap}code{word-wrap:break-word}li,ul{margin:.2em 0}hr{border:0;height:4px;padding:0}a:first-child h1,a:first-child h2,a:first-child h3,a:first-child h4,a:first-child h5,a:first-child h6,bo dy>h5:first-child,body>h1:first-child,body>h1:first-child+h2,body>h2:first-child,body>h3:first-child,body>h4:first-child,body>h6:first-child{margin-top:0;padding-top:0}h1 p,h2 p,h3 p,h4 p,h5 p,h6 p{margin-top:0}li p.first{display:inline-block}ol,ul{padding-left:30px}ol:first-child,ul:first-child{margin-top:0}dl,dl dt{padding:0;font-size:4vmin}dl dt{font-weight:700;margin:15px 0 5px}dl dt:first-child{padding:0}dl dt>:first-child{margin-top:0}dl dt>:last-child{margin-bottom:0}dl dd{margin:0 0 15px;padding:0 15px}dl dd>:first-child{margin-top:0}dl dd>:last-child{margin-bottom:0}blockquote{border-left:4px solid #ddd;padding:0 15px;color:#777}blockquote>:first-child{margin-top:0}blockquote>:last-child{margin-bottom:0}table{padding:0;border-spacing:2px;border-collapse:collapse;max-width:90%;margin:auto}table,td,th{border:1px solid #ccc;font-size:90%}table tr,td,th{padding:0;margin:0}table tr{background-color:#fff;border-top:1px solid #c6cbd1}table tr:nth-child(2n){background-color:#f6f8fa}table tr th{font-weight:700;white-space:nowrap}table tr td,table tr th{border:1px solid #ccc;text-align:center;margin:0;padding:6px 13px}table tr td:first-child,table tr th:first-child{margin-top:0}img{max-height:100%;max-width:100%}code,tt{margin:1%;padding:.2% 1%;white-space:nowrap;border:1px solid #eaeaea;background-color:#f8f8f8;border-radius:3px}pre code{margin:0;padding:0;white-space:pre;border:0;background:0}.highlight pre,pre{border:1px solid #ccc;font-size:13px;line-height:19px;overflow:auto;padding:6px 10px;border-radius:3px}pre code,pre tt{background-color:transparent;border:0}.main-content{position:relative}.sub{position:absolute;padding:5vh 10vw;width:80vw;height:90vh;overflow-y:hidden}hr{border:0!important;color:#fff;height:4px}#page_num{border:0;position:absolute;left:95vw;top:90vh;margin-right:0;bottom:10}.controller{width:50px;position:absolute;right:0;bottom:0}
`
	}
